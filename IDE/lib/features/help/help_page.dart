    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'تظهر مكتبة البلوكات الآن أفقيا أسفل الشاشة، وكل بلوك يظهر بشكل بازل تعليمي بلون مجموعته. يمكن سحب البلوكات من المكتبة وإفلاتها في مساحة البرنامج، وتظهر تفاصيل مستوى البلوك وغرضه داخل تلميح المعلومات.',
        ),
      ],
    );
  }
