    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'تظهر مكتبة البلوكات الآن أفقيا أسفل الشاشة، وكل بلوك يظهر بشكل قريب من بلوكات Scratch و App Inventor بلون مجموعته. يمكن سحب البلوكات وإفلاتها في مساحة البرنامج، ويظهر مستوى البلوك وغرضه عند الوقوف على أي مكان من البلوك.',
        ),
      ],
    );
  }
