    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'تظهر مكتبة البلوكات أفقيا أسفل الشاشة، وكل بلوك يظهر بشكل قريب من بلوكات Scratch و App Inventor بلون مجموعته. يمكن إفلات البلوك بين البلوكات أو داخل بلوكات حاوية مثل إعداد، حلقة، إذا، وتعريف تابع.',
        ),
      ],
    );
  }
