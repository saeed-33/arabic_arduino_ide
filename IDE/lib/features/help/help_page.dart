    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'يبدأ برنامج التعلم بتابعين أساسيين initialize/إعداد و loop/حلقة. تظهر لوحة يمين تعرض التوابع والمتغيرات العامة وتسمح بإضافة تابع جديد أو متغير عام، ويمكن إفلات البلوكات من اليمين إلى اليسار بين البلوكات أو داخل الحاويات.',
        ),
        const _HelpItem(
          title: 'التنقل',
          body:
              'تظهر خيارات المحترف، التعلم، المطور، المساعدة، والإعدادات في شريط أفقي أعلى الشاشة.',
        ),
        const _HelpItem(
          title: 'إصلاحات الاستقرار',
          body:
              'تم إصلاح أخطاء عرض بلوكات التعلم وحذف البلوكات المتداخلة، وأصبحت ملفات التطبيق تمر من فحص Dart بدون مشاكل.',
        ),
      ],
    );
  }
