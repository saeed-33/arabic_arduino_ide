    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'يحتوي الآن على مكتبة بلوكات مقسمة إلى مجموعات ملوّنة ومسمّاة، وكل بلوك يأخذ لون مجموعته. مساحة البرنامج تعرض البلوكات بشكل أوضح، والمعاينة الاختيارية تضيف تحذيرات تعليمية عند وضع أوامر تحتاج أن تكون داخل دالة.',
        ),
      ],
    );
  }
