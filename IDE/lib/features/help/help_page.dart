    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'يحتوي الآن على مكتبة بلوكات بتبويبات أفقية أسفل المكتبة، وكل تبويب وبلوك يأخذ لون مجموعته. البلوكات داخل المجموعة ومساحة تركيب البرنامج تعرض أفقيا، والمعاينة الاختيارية تضيف تحذيرات تعليمية عند وضع أوامر تحتاج أن تكون داخل دالة.',
        ),
      ],
    );
  }
