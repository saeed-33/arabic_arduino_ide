    ...
    return ListView(
      ...
      children: [
        ...
        const _HelpItem(
          title: 'وضع التعلم',
          body:
              'يحتوي الآن على مكتبة بلوكات بتبويبات أفقية أسفل المكتبة، وكل تبويب وبلوك يأخذ لون مجموعته. البلوكات داخل المجموعة ومساحة تركيب البرنامج تعرض أفقيا، وتظهر تفاصيل مستوى البلوك وغرضه داخل تلميح المعلومات بدلا من نص دائم.',
        ),
      ],
    );
  }
