          ...
          child: Column(
            ...
            children: [
              ...
              const TabBar(
                isScrollable: true,
                tabs: [
                  Tab(text: 'شجرة التحليل'),
                  Tab(text: 'الشجرة المجردة'),
                  Tab(text: 'الرموز'),
                  Tab(text: 'الأخطاء الخام'),
                  Tab(text: 'الأخطاء المفسرة'),
                  Tab(text: 'الكود المُولد'),
                  Tab(text: 'الخط الأنبوبي'),
                  Tab(text: 'السجلات الداخلية'),
                  Tab(text: 'البيئة'),
                ],
              ),
              Expanded(
